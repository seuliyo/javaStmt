...
public class ComparisionDemo2 {
	public static void main(String[] args) {
		...
		// 다중의 if문을 한가지 로직으로 합쳐야 할 경우라면 if else 구문을 사용한다.
		...
		if(val01 > val02){ //val01이 val02 보다 크다면
			System.out.println("val01이 val02 보다 크다");
		}else
		if(val01 < val02){ //val01이 val02 보다 작다면
			System.out.println("val01이 val02 보다 작다");
		}
